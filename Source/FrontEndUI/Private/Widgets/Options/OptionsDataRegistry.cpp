...
void UOptionsDataRegistry::InitGameplayCollectionTab()
{
	...
	// This is the full code for constructing data interaction helper

	/*TSharedPtr<FOptionsDataInteractionHelper> ConstructedHelper = 
		MakeShared<FOptionsDataInteractionHelper>(
		GET_FUNCTION_STRING_NAME_CHECKED(UFrontEndGameUserSettings, GetCurrentGameDifficulty)
	);*/
	...
	// Game Difficulty
	{
		...
		GameDifficulty->SetDescriptionRichText(FText::FromString(TEXT("Adjusts the difficulty of the gameplay experience.\n\n<Bold>Easy:</> Focuses on a storytelling experience.\n\n<Bold>Normal:</> For those who want a bit more challenge with a storytelling experience.\n\n<Bold>Hard:</> A more challenging combat experience.\n\n<Bold>Nightmare:</> Get your thumbs ready! This will challenge even the most savvy veterans!")));
		GameDifficulty->AddDynamicOption(TEXT("Easy"), FText::FromString(TEXT("Easy")));
		GameDifficulty->AddDynamicOption(TEXT("Normal"), FText::FromString(TEXT("Normal")));
		GameDifficulty->AddDynamicOption(TEXT("Hard"), FText::FromString(TEXT("Hard")));
		GameDifficulty->AddDynamicOption(TEXT("Nightmare"), FText::FromString(TEXT("Nightmare")));
	...
	// Test Item
	{
		...
		TestItem->SetDescriptionRichText(FText::FromString(TEXT("The image to display can be specified in the project settings. It can be anything the developr assigns in there")));
...
void UOptionsDataRegistry::InitAudioCollectionTab()
{
	...
	// Volume Category
	{
		...
		// Overall Volume
		{
			...
			OverallVolume->SetDescriptionRichText(FText::FromString(TEXT("This is the description for overall volume")));
		...
		// Music Volume
		{
			...
			MusicVolume->SetDescriptionRichText(FText::FromString(TEXT("This is the description for Music Volume")));
		...
		// Sound FX Volume
		{
			...
			SoundFXVolume->SetDescriptionRichText(FText::FromString(TEXT("This is the description for Sound FX Volume")));
...
void UOptionsDataRegistry::InitVideoCollectionTab()
{
	...
	// Graphics Category
	{
		...
		// Display Gamma
		{
			...
			DisplayGamma->SetOutputValueRange(TRange<float>(1.7f, 2.7f)); // The default value has is 2.2f
		...
		// Visual Effects Quality
		{
			...
			VisualEffectsQuality->SetDataDisplayName(FText::FromString(TEXT("Visual Effect Quality")));
		...
		// Post Processing Quality
		{
			...
			PostProcessingQuality->SetDataDisplayName(FText::FromString(TEXT("Post ProcessingQuality")));
